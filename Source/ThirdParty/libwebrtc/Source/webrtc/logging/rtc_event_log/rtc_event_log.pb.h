...
const Event_EventType Event_EventType_EventType_MAX = Event_EventType_REMOTE_ESTIMATE;
...
class Event : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:webrtc.rtclog.Event) */ {
 public:
  ...
  static const EventType REMOTE_ESTIMATE =
  ...
  static const int kRemoteEstimateFieldNumber = 22;
  private:
  ...
  ::webrtc::rtclog::RemoteEstimate* release_remote_estimate();
...
class RemoteEstimate : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:webrtc.rtclog.RemoteEstimate) */ {
 public:
  RemoteEstimate();
  ...
  void Swap(RemoteEstimate* other);
  ...
  inline RemoteEstimate* New() const final {
    return CreateMaybeMessage<RemoteEstimate>(NULL);
  }

  RemoteEstimate* New(::google::protobuf::Arena* arena) const final {
  ...
  static const int kLinkCapacityLowerKbpsFieldNumber = 1;
  ...
  static const int kLinkCapacityUpperKbpsFieldNumber = 2;
...
inline ::webrtc::rtclog::RemoteEstimate* Event::release_remote_estimate() {
  ...
  if (has_remote_estimate()) {
    ...
    subtype_.remote_estimate_ = NULL;
    return temp;
  } else {
    return NULL;
  }
...
inline ::webrtc::rtclog::RemoteEstimate* Event::mutable_remote_estimate() {
  if (!has_remote_estimate()) {
    ...
    subtype_.remote_estimate_ = CreateMaybeMessage< ::webrtc::rtclog::RemoteEstimate >(
        GetArenaNoVirtual());
  }
...
inline void RemoteEstimate::set_has_link_capacity_lower_kbps() {
  _has_bits_[0] |= 0x00000001u;
}
inline void RemoteEstimate::clear_has_link_capacity_lower_kbps() {
  _has_bits_[0] &= ~0x00000001u;
}
...
inline ::google::protobuf::uint32 RemoteEstimate::link_capacity_lower_kbps() const {
  // @@protoc_insertion_point(field_get:webrtc.rtclog.RemoteEstimate.link_capacity_lower_kbps)
  return link_capacity_lower_kbps_;
}
inline void RemoteEstimate::set_link_capacity_lower_kbps(::google::protobuf::uint32 value) {
...
inline void RemoteEstimate::set_has_link_capacity_upper_kbps() {
  _has_bits_[0] |= 0x00000002u;
}
inline void RemoteEstimate::clear_has_link_capacity_upper_kbps() {
  _has_bits_[0] &= ~0x00000002u;
}
...
inline ::google::protobuf::uint32 RemoteEstimate::link_capacity_upper_kbps() const {
  // @@protoc_insertion_point(field_get:webrtc.rtclog.RemoteEstimate.link_capacity_upper_kbps)
  return link_capacity_upper_kbps_;
}
inline void RemoteEstimate::set_link_capacity_upper_kbps(::google::protobuf::uint32 value) {
