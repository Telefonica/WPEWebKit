...
WEBKIT_OPTION_DEFAULT_PORT_VALUE(ENABLE_OPENCDM PRIVATE ON)
WEBKIT_OPTION_DEFAULT_PORT_VALUE(ENABLE_CLEARKEY PRIVATE OFF)
...
if (ENABLE_ENCRYPTED_MEDIA)
    message (STATUS "ENABLE_ENCRYPTED_MEDIA set")
    if(ENABLE_THUNDER)
        message (STATUS "ENABLE_THUNDER set")
        find_package(Thunder REQUIRED)
    endif()
    if(ENABLE_OPENCDM)
        message (STATUS "ENABLE_OPENCDM set")
        find_package(OpenCDM REQUIRED)
        if (NOT OPENCDM_FOUND)
            message(FATAL_ERROR "OpenCDM is needed for ENABLE_ENCRYPTED_MEDIA.")
        endif ()
    else ()
        message (STATUS "ENABLE_OPENCDM NOT set")
    endif ()

    if(ENABLE_CLEARKEY)
        message (STATUS "ENABLE_CLEARKEY set")
    else()
        message (STATUS "ENABLE_CLEARKEY NOT set")
    endif()

    if (NOT ENABLE_THUNDER AND NOT ENABLE_OPENCDM)
        message(FATAL_ERROR "ENABLE_ENCRYPTED_MEDIA. without OPENCDM or THUNDER")
    endif ()
