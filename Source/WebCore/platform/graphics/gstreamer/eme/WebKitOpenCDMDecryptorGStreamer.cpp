...
#if ENABLE(ENCRYPTED_MEDIA) && USE(GSTREAMER) && (USE(OPENCDM) || USE(PLAYREADY) || USE(WIDEVINE))
...
#endif // ENABLE(ENCRYPTED_MEDIA) && USE(GSTREAMER) && USE(OPENCDM) || USE(PLAYREADY) || USE(WIDEVINE))
