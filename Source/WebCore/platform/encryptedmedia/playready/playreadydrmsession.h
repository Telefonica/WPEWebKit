 ...
 */
class PlayReadyDRMSession : public CDMDrmSession
{
...
public:
	...
	void generateCDMDRMSession(const uint8_t *f_pbInitData,
			uint32_t f_cbInitData);

	DrmData * CDMGenerateKeyRequest(string& destinationURL);

	int CDMDRMProcessKey(DrmData* key);
