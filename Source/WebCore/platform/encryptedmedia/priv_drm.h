...
public:
	...
	TriState_priv playlistsParallelFetch;        /**< Enabled parallel fetching of audio & video playlists*/
	TriState_priv enableBulkTimedMetaReport;		/**< Enabled Bulk event reporting for TimedMetadata*/
	TriState_priv mWesterosSinkConfig;		/**< Enalbe Westeros sink from application */
	TriState_priv mEnableRectPropertyCfg;        /**< Allow or deny rectangle property set for sink element*/
